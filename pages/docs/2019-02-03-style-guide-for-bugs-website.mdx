import LatexLayout from '../../components/Latex';

# Style Guide for BUGS Website
To improve readability of code in the future, ensure consistency accross the
codebase, and also to make it easier to make PR’s for Hacktoberfest, I’m making
a style guide for the BUGS website, documenting best practices to keep in mind
while writing HTML, SASS, and Liquid for the site, as well as general organizational
...
export default ({ children }) => <LatexLayout>{children}</LatexLayout>;
