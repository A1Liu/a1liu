 ...
 * public api Method names are shortened.
 *
 * @author aliu
 *
 */
public final class Debug {
   ...
   */
  public static <T> void pArr(T[] array) { sp(arrayToList(array).toString()); }
   ...
   * @param array array to print
   */
  public static void pArr(boolean[] array) {
   ...
   * printStream.println
   */
  public static void sp() { PRINT_STREAM.println(); }
  ...
  public static void p() {
    PRINT_STREAM.printf("Print statement called at %s",
  ...
  public static void p(Object o) {
    ...
    PRINT_STREAM.printf(
        "Object class: <%s>%nObject value: [%s]%nPrint Called at: %s%n",
        outputClass, output,
        Thread.currentThread()
            .getStackTrace()[2]
            .toString()); // prints out the location of where this statement was
                          // called
  }
   ...
   */
  public static String l() { return stackString(); }
   ...
   */
  public static void f(String file) { filePath = file; }
   ...
   */
  public static BufferedReader r() { return READER; }

  /**
   * Gets a scanner of System.in
   * @return a Scanner object
   */
  public static Scanner sc() { return SCANNER; }
   ...
   * setDefaultSleep
   */
  public static void slp() { slp(DEFAULT_SLEEP_TIME); }
   ...
   */
  public static void tr() { sysTimer = new Timer(); }
   ...
   */
  public static long tss() { return sysTimer.timeSinceStart(); }
  ...
  /**
   * Changes the InputStream that Debug methods get input from (System.in by
   * default)
